...
export class InferenceStack extends NestedStack {
  ...
  constructor(scope: Construct, id: string, props: InferenceProps) {
    ...
    this.templateOptions.description = '(SO9076) - Real-time Fraud Detection with Graph Neural Network on DGL -- real-time inference for fraudulent transactions stack.';
  }
}