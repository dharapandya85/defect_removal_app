...
//import { getFraudTransactions, getTransactionStats } from 'src/graphql/queries';
...
const Dashboard: React.FC = () => {
  ...
  const simulateData = () => {
    const duration = 600; // Example default value
    const concurrent = 5; // Example default value
    const dataInterval = 10; 
    ...
    const data = {
      input: {
        ...
        interval: parseInt(dataInterval as unknown as string) * 1000,
      },
    };
  ...
  return (
    <div>
      ...
      <div className="fds-dashboard-summury">
        <CountCard title='card.fraudCount' value={fraudCount} classIndex="1" />
        <CountCard title='card.transcationCount' value={totalCount} classIndex="2" />
        <CountCard title='card.fraudAmount' value={`$${numberFormatter(fraudAmount, 2)}`} classIndex="3" />
        <CountCard
          title='card.transcationAmount'
      ...
      >
        <DialogTitle id="alert-dialog-title">{'simulate.title'}</DialogTitle>
        <DialogContent className="csp-w-500">
          <FormControl fullWidth variant="outlined">
            <div className="form-title">
              {'simulate.durationTitle'}: <span>(('simulate.durationTips'))</span>
            </div>
            <TextField
          ...
          <FormControl fullWidth variant="outlined" className="csp-mt-10">
            <div className="form-title">
              ('simulate.concurrentTitle'):<span>(('simulate.concurrentTips'))</span>
            </div>
            <TextField
              onChange={(event: React.ChangeEvent<HTMLInputElement>) => {
          ...
          <FormControl fullWidth variant="outlined" className="csp-mt-10">
            <div className="form-title">
              {'simulate.intervalTitle'}:<span>(('simulate.intervalTips'))</span>
            </div>
            <TextField
              onChange={(e)=> {
...
function t(arg0: string): string | HTMLElement | JQuery | undefined {
